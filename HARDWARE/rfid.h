...
#include "beep.h"
//////////////////////////////////////////////////////////////////////////////////	 
//  功能描述  : RFID模块演示例程(STM32F407ZET6系列)
//              说明: 
//              ----------------------------------------------------------------
//              NSS ： PD7    ----SDA
//				SCK	： PD6
...
/***********************RC522 函数宏定义**********************/
#define          RC522_CS(n)        	 n?GPIO_SetBits(GPIOA, GPIO_Pin_4):GPIO_ResetBits(GPIOA,GPIO_Pin_4)//0是enable，1是disable
//#define          RC522_CS_Disable()        GPIO_SetBits ( GPIOA, GPIO_Pin_4 )

#define          RC522_Reset(n)     	 n?GPIO_SetBits(GPIOB, GPIO_Pin_0):GPIO_ResetBits(GPIOB,GPIO_Pin_0)//0是enable，1是disable
//#define          RC522_Reset_Disable()     GPIO_SetBits ( GPIOB, GPIO_Pin_0 )

#define          RC522_SCK(n)            n?GPIO_SetBits(GPIOA,GPIO_Pin_5):GPIO_ResetBits(GPIOA,GPIO_Pin_5)
//#define          RC522_SCK_1()             GPIO_SetBits ( GPIOA, GPIO_Pin_5 )

#define          RC522_MOSI(n)           n?GPIO_SetBits(GPIOA,GPIO_Pin_7):GPIO_ResetBits(GPIOA,GPIO_Pin_7)
//#define          RC522_MOSI_1()            GPIO_SetBits ( GPIOA, GPIO_Pin_7 )

#define          RC522_MISO_READ          GPIO_ReadInputDataBit (GPIOA,GPIO_Pin_6)
...
void Write_card(u8  *card_pydebuf ,u8  *card_numberbuf ,u8  *card_key0Abuf , u8  *card_writebuf);
u8 Read_card(u8  *card_pydebuf ,u8  *card_numberbuf ,u8  *card_key0Abuf , u8  *card_readbuf);
